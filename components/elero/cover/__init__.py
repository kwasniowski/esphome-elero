...
CONFIG_SCHEMA = cover.cover_schema(EleroCover).extend(
    {
        ...
        cv.Optional(CONF_OPEN_DURATION, default="66s"): cv.positive_time_period_milliseconds,
        cv.Optional(CONF_CLOSE_DURATION, default="61s"): cv.positive_time_period_milliseconds,
        cv.Optional(CONF_TILT_DURATION, default="7.5s"): cv.positive_time_period_milliseconds,
